...
```bash
tk profile create [NAME] --organization-id ORG_UUID
tk login [NAME]
tk auth status
...
```bash
# Create the default profile with a freshly generated credential, register
# the printed public key with Turnkey, then log in.
