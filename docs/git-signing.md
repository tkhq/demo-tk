...
its fingerprint in `$FINGERPRINT`, then point Git at `tk`:
...
- [deploying-signing-broker](../skills/deploying-signing-broker/SKILL.md): configuring Git in the application container to sign through the broker's socket.
